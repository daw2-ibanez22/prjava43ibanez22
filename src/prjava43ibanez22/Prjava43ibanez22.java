...
public class Prjava43ibanez22 extends Frame 
   ...
   public Prjava43ibanez22 () { 
      ...
      setTitle("nova finestra prjava43ibanez22");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43ibanez22();  // Let the construct do the job 
   } 
